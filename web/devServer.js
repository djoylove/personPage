...
var port = isProduction ? (process.env.PORT || 80) : 3004;

// app.use('/api/*', proxy({ target: 'http://api.btcmaster.cn', changeOrigin: true, secure: false })); // 与后台联调时,如果后台没有做跨域处理的话,可以通过设置代理的方式来解决跨域的问题
